...
- [docs/agent-orchestration/SPEC.md](docs/agent-orchestration/SPEC.md) defines the repo-local Symphony-style agent orchestration contract for GitHub issue eligibility, branch/worktree ownership, safety gates, verification, observability, and handoff states. [WORKFLOW.md](WORKFLOW.md) is the concise workflow prompt/config contract for agents claiming or reconciling issue work.
