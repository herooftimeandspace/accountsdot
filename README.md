...
- [docs/operations/health-observability.md](docs/operations/health-observability.md) defines the Phase 0 `/health/live`, `/health/ready`, `/health`, and `/metrics` semantics for dependency, global-pause, and staging observability evidence.
