...
- The shared help icon opens the shared right-hand drawer with end-user documentation for the current page. The drawer copy must describe what the page does and how to use it in plain language for non-technical operators. It is not technical implementation help. When PRD or implementation behavior changes for a page, that page's help copy must be refreshed in the same change set.
