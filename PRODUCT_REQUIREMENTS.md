...
- Missing manual Non-Escape required fields are summarized inside the drawer status bubble and highlighted on the field controls using the brand red `#D73533`, exposed in the frontend as `var(--color-accent-red)`.
