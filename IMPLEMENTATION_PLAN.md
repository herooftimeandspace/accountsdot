...
- Onboarding and offboarding dashboard behavior:
  ...
  - the two top-level Offboarding manual-action buttons render as one right-side vertical action group, not side by side, so the related HR/IT workflows stay connected to the dashboard header/action area without excess horizontal whitespace
