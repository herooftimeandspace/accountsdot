const ROUTE_SOURCE_NOTES = {
  "/dashboard/it-admin": "PRODUCT_REQUIREMENTS.md dashboard and admin visibility scope; IMPLEMENTATION_PLAN.md implemented-page shell and IT Admin warnings.",
  "/dashboard/hr-lifecycle": "PRODUCT_REQUIREMENTS.md HR lifecycle dashboard scope; IMPLEMENTATION_PLAN.md implemented-page shell and onboarding/offboarding routing.",
  "/dashboard/site-admin": "PRODUCT_REQUIREMENTS.md site-admin visibility scope; IMPLEMENTATION_PLAN.md implemented-page shell and site-owned queue routing.",
  "/search": "PRODUCT_REQUIREMENTS.md shared search and staff-only access scope; IMPLEMENTATION_PLAN.md implemented-page shell behavior.",
  "/onboarding": "PRODUCT_REQUIREMENTS.md Onboarding pre-phase 0 behavior; IMPLEMENTATION_PLAN.md Onboarding runtime drawer and manual intake contracts.",
  "/offboarding": "PRODUCT_REQUIREMENTS.md Offboarding pre-phase 0 behavior; IMPLEMENTATION_PLAN.md Offboarding runtime drawer and end-date ownership contracts.",
  "/departing-seniors": "PRODUCT_REQUIREMENTS.md Departing Seniors requirements; IMPLEMENTATION_PLAN.md account retirement and device-return drawer contracts.",
  "/room-moves": "PRODUCT_REQUIREMENTS.md Room Moves workflow; IMPLEMENTATION_PLAN.md room move execution, correction, warning, and revert contracts.",
  "/room-moves/bulk-draft": "PRODUCT_REQUIREMENTS.md Room Moves batch/site rollover scope; IMPLEMENTATION_PLAN.md bulk draft review and cutover contracts.",
  "/phone-directory/by-person": "PRODUCT_REQUIREMENTS.md Phone Directory person mode; IMPLEMENTATION_PLAN.md directory runtime view and detail-drawer contracts.",
  "/phone-directory/by-room": "PRODUCT_REQUIREMENTS.md Phone Directory room mode; IMPLEMENTATION_PLAN.md directory runtime view and detail-drawer contracts.",
  "/phone-directory/by-department": "PRODUCT_REQUIREMENTS.md Phone Directory department mode; IMPLEMENTATION_PLAN.md directory runtime view and detail-drawer contracts.",
  "/data-quality": "PRODUCT_REQUIREMENTS.md Data Quality routing limits; IMPLEMENTATION_PLAN.md issue #57 decision and Data Quality queue behavior.",
  "/frequent-fliers": "PRODUCT_REQUIREMENTS.md Frequent Fliers support-analysis scope; IMPLEMENTATION_PLAN.md configurable lookback, filters, and drawer contracts.",
  "/student-data-cleanup": "PRODUCT_REQUIREMENTS.md Student Data Cleanup Aeries correction contract; IMPLEMENTATION_PLAN.md runtime table, filters, and drawer behavior.",
  "/reports": "PRODUCT_REQUIREMENTS.md Reports inventory and refresh drawer requirements; IMPLEMENTATION_PLAN.md Reports runtime table/search/sort behavior.",
  "/reports/security-issues": "PRODUCT_REQUIREMENTS.md Security Issues report migration; IMPLEMENTATION_PLAN.md read-only IT Admin report and drawer details.",
  "/reports/sync-transparency": "PRODUCT_REQUIREMENTS.md sync visibility goals; IMPLEMENTATION_PLAN.md sync transparency report and manual-action state guidance.",
  "/reports/ticketing-human-work": "PRODUCT_REQUIREMENTS.md IncidentIQ human-work fallback; IMPLEMENTATION_PLAN.md ticketing report and manual owner contracts.",
  "/admin": "PRODUCT_REQUIREMENTS.md IT Admin control scope; IMPLEMENTATION_PLAN.md Admin sync, exception, reversal, and emergency-control behavior.",
  "/admin/feature-flags": "PRODUCT_REQUIREMENTS.md staged rollout and staff-only controls; IMPLEMENTATION_PLAN.md DEV feature flag control surface.",
  "/my-profile": "PRODUCT_REQUIREMENTS.md account menu and staff profile scope; IMPLEMENTATION_PLAN.md shared shell profile affordance.",
};
