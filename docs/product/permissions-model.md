...
- InformedK12-backed primary-site selections are not permission grants. They may provide the employee's active dashboard primary site for workflow planning and non-permission site context, but they must not create Site Admin, Site Secretary, Device Wrangler, Human Resources, IT Admin, or other operational permissions. Any site-scoped operational access still requires the normal SAML, Google, breakglass, manual grant, revocation, and feature-rollout resolution described in this document.
