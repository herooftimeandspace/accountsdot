...
- Employee-affecting manual changes created through the website must carry an explicit lifecycle classification before they can participate in school-year rollover:
  ...
  - temporary HR site overrides, temporary HR room/location overrides, and InformedK12-backed primary-site selections persist until upstream Escape/Aeries correction, a job-assignment change, a superseding form-supported decision, or HR reconciliation proves the manual value is obsolete
...
- The selection persists until one of these clear conditions occurs: current Escape/Aeries source data now unambiguously matches the selected site, the employee receives a superseding Escape job assignment that changes the primary-site decision, HR/IT records a superseding form-supported selection, or HR/IT manually marks the row reconciled or cleared with an audit reason. It must not disappear merely because a form becomes old or because a sync job reruns.
